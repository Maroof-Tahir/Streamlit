...
server_options = {
    "Azure SQL": "https://path-to-azure-sql-image.png",
    "MongoDB": "https://path-to-mongodb-image.png",
    "MySQL": "https://path-to-mysql-image.png",
    "PostgreSQL": "https://path-to-postgresql-image.png",
    "SQL Server": "https://path-to-sql-server-image.png"
}
